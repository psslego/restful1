...
class CurrentRecipe(models.Model):
    ...
    recipe_menu = models.ForeignKey('Recipe', models.DO_NOTHING, db_column='RECIPE_menu')  # Field name made lowercase.

    class Meta:
        managed = False
        db_table = 'current_recipe'
        unique_together = (('user', 'recipe_menu'),)
...
class Recipe(models.Model):
    menu = models.CharField(primary_key=True, max_length=20)
    ingredient = models.TextField(blank=True, null=True)  # This field type is a guess.
